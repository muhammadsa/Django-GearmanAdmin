...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RefreshRate.selected'
        db.add_column(u'GearmanMonitor_refreshrate', 'selected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RefreshRate.selected'
        db.delete_column(u'GearmanMonitor_refreshrate', 'selected')
